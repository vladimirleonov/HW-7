...
//     defaultSortBy: string | string[] = 'created_at',
//   ) {
...
//     }
//
//     // sortBy и sortDirection
//     const sortBy: string =
//       query.sortBy || (Array.isArray(defaultSortBy) ? '' : defaultSortBy);
...
//           },
//         ]
//       : defaultSortArray.filter((s) => sortProperties.includes(s.field));
//   }
//
...
// //   ): { field: string; direction: SortDirectionType }[] {
// //     if (Array.isArray(query.sort)) {
// //       // new format: array strings "field direction"
// //       return query.sort
// //         .map((s) => {
// //           const [field, direction] = s.split(' ');
// //
...
// //     }
// //
// //     // old format: sortBy и sortDirection
